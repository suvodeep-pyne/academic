...
# https://github.com/jbutewicz/An-Introduction-to-Interactive-Programming-in-Python.git
# An-Introduction-to-Interactive-Programming-in-Python/Principles of Computing Week 1/2048.py
#
...
class TwentyFortyEight:
  ...
  def __init__(self, grid_height, grid_width):
    ...
    self.reset()  # Compute inital row dictionary to make move code cleaner
    self.initial = {
